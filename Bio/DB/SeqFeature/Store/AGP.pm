package Bio::DB::SeqFeature::Store::AGP;

=head1 NAME

Bio::DB::SeqFeature::Store::AGP -- Experiment

=head1 SYNOPSIS

  use Bio::DB::SeqFeature::Store;

  # Open a sequence database
  my $db1 = Bio::DB::SeqFeature::Store->
    new( -adaptor => 'DBI::mysql',
         -dsn     => 'dbi:mysql:test',
       );

  # Open the AGP sequence database
  my $db2 = Bio::DB::SeqFeature::Store->
    new( -adaptor => 'AGP',
         -dsn     => '/var/databases/test.agp',
         -store   => $db1
       );
